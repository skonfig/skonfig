...
tests_base_path = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
skonfig_exec_path = os.path.join(tests_base_path, "bin/skonfig")
...
class SkonfigTestCase(unittest.TestCase):
    ...
    def mkdtemp(self, **kwargs):
        return tempfile.mkdtemp(prefix='tmp.test.', **kwargs)
