...
# -*- coding: utf-8 -*-
#
# skonfig-docs documentation build configuration file, created by
...
release = skonfig.__version__ if skonfig.__version__[0].isdigit() else "1.0"
# The short X.Y version.
version = re.match(r'^[0-9.]+', release).group(0)
...
html_title = 'skonfig %s documentation' % (release)
...
# of the sidebar.
html_logo = '_static/skonfig-logo.png'
...
latex_documents = [
    (master_doc, 'skonfig.tex', html_title,
     author, 'manual'),
]
